      ...
      <div className="report-detail-content">
        ...
        <div className="report-detail-content-top">
          <div className='report-detail-content-top-user'>
            <img src={personIcon} alt="person-icon" className='report-detail-person-icon' />
            <div>
        ...
        <div className="report-detail-content-bottom">
          <div className="report-detail-content-bottom-left">
            <div className='report-detail-content-bottom-left-detail'>
              <p className='report-detail-content-category-location'>{report.category.label} at {report.location}</p>
              <p className='report-detail-content-timeframe'>{report.postedAgo}</p>
          ...
          <div className="report-detail-content-bottom-right">
            <img src={imagePlaceholder} alt="road" className='report-detail-image-placeholder' />
          </div>
          ) : <></>
          }
        </div>
