        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.loginItems}>
                    <View>
                        <Text style={styles.loginPageHeader}>Signup</Text>
                    </View>
                    <View style={styles.loginForm}>
                        ...
                        <View style={styles.formsItems}>
                            ...
                            <View style={{flexDirection: 'row', padding: 10, borderColor: '#818181', borderWidth: 1, borderRadius: 10, width: '100%', height: 45, justifyContent: 'space-between', alignItems: 'center' }}>
                                <TextInput 
                                    style={{width: '80%'}} 
                                    secureTextEntry={confHidden}
                                    onChangeText={newConfPassword => setConfPassword(newConfPassword)}
                                    defaultValue={confPassword}/>
                                <TouchableOpacity style={{width: '20%', alignItems: 'center', justifyContent: 'center', alignItems: 'flex-end'}} onPress={() => setConfHidden(!confHidden)}>
                                    <Text>Show</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <TouchableOpacity style={styles.loginButton} onPress={checkLogin}>
                            <Text style={styles.defText}>Signup</Text>
                        </TouchableOpacity>
